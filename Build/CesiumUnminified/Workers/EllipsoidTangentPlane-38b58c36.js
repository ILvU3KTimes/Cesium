...
define([
  ...
  function AxisAlignedBoundingBox(minimum, maximum, center) {
     ...
     */
    this.minimum = Cartesian2.Cartesian3.clone(
      when.defaultValue(minimum, Cartesian2.Cartesian3.ZERO)
    );
     ...
     * @default {@link Cartesian3.ZERO}
     */
    this.maximum = Cartesian2.Cartesian3.clone(
      when.defaultValue(maximum, Cartesian2.Cartesian3.ZERO)
    );

    //If center was not defined, compute it.
    if (!when.defined(center)) {
      center = Cartesian2.Cartesian3.midpoint(
        this.minimum,
        this.maximum,
  ...
  AxisAlignedBoundingBox.fromPoints = function (positions, result) {
    ...
    if (!when.defined(positions) || positions.length === 0) {
      result.minimum = Cartesian2.Cartesian3.clone(
        Cartesian2.Cartesian3.ZERO,
        result.minimum
      );
      result.maximum = Cartesian2.Cartesian3.clone(
        Cartesian2.Cartesian3.ZERO,
        result.maximum
      );
      result.center = Cartesian2.Cartesian3.clone(
        Cartesian2.Cartesian3.ZERO,
        result.center
      );
      return result;
    ...
    result.center = Cartesian2.Cartesian3.midpoint(
      minimum,
      maximum,
      result.center
    );
  ...
  AxisAlignedBoundingBox.intersectPlane = function (box, plane) {
    ...
    var h = Cartesian2.Cartesian3.multiplyByScalar(
      intersectScratch,
      0.5,
      intersectScratch
  ...
  function EllipsoidTangentPlane(origin, ellipsoid) {
    ...
    var eastNorthUp = Transforms.Transforms.eastNorthUpToFixedFrame(
      origin,
      ellipsoid
    );
