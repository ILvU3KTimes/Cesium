...
define([
  ...
  function addEndCaps(calculatedPositions) {
    ...
    endPoint = Cartesian2.Cartesian3.fromArray(
      calculatedPositions[0],
      0,
      endPoint
    );
    cornerPoint = Cartesian2.Cartesian3.midpoint(
      startPoint,
      endPoint,
      cornerPoint
    );
  ...
  function computeMiteredCorner(
    ...
    if (leftIsOutside) {
      cornerPoint = Cartesian2.Cartesian3.add(
        position,
        leftCornerDirection,
        cornerPoint
      );
  ...
  function addShiftedPositions(positions, left, scalar, calculatedPositions) {
    ...
    var scaledLeft = Cartesian2.Cartesian3.multiplyByScalar(
      left,
      scalar,
      scratch1
    );
    ...
    for (i = 1; i < length - 1; i++) {
      ...
      if (doCorner) {
        ...
        if (leftIsOutside) {
          ...
          scaleArray2[0] = Cartesian2.Cartesian3.clone(
            previousPos,
            scaleArray2[0]
          );
