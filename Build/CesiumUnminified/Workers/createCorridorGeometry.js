...
define([
  ...
  "./CorridorGeometryLibrary-a1493a93",
], function (
  when,
  Check,
  _Math,
      ...
      if (when.defined(l)) {
        ...
        left = Cartesian2.Cartesian3.normalize(
          Cartesian2.Cartesian3.negate(
            Cartesian2.Cartesian3.add(nextPoint, previousPoint, left),
            left
          ),
          left
        );
  ...
  function extrudedAttributes(attributes, vertexFormat) {
    ...
    if (vertexFormat.normal || vertexFormat.bitangent || vertexFormat.tangent) {
      ...
      for (i = 0; i < threeSize; i += 3) {
        ...
        topPosition = Cartesian2.Cartesian3.fromArray(
          positions,
          i,
          topPosition
        );
  ...
  function computePositionsExtruded(params, vertexFormat) {
    ...
    var computedPositions = CorridorGeometryLibrary.CorridorGeometryLibrary.computePositions(
      params
    );
    ...
    if (when.defined(params.offsetAttribute)) {
      ...
      if (
        ...
        applyOffset = GeometryOffsetAttribute.arrayFill(
          applyOffset,
          1,
          0,
          size
  ...
  function computeOffsetPoints(
    ...
    var direction = Cartesian2.Cartesian3.subtract(
      position2,
      position1,
      scratchCartesian1
    );
    ...
    var offsetDirection = Cartesian2.Cartesian3.cross(
      direction,
      normal,
      scratchCartesian1
    );
  ...
  CorridorGeometry.computeRectangle = function (options, result) {
    ...
    var cornerType = when.defaultValue(
      options.cornerType,
      PolylineVolumeGeometryLibrary.CornerType.ROUNDED
    );
  ...
  function createCorridorGeometry(corridorGeometry, offset) {
    ...
    corridorGeometry._ellipsoid = Cartesian2.Ellipsoid.clone(
