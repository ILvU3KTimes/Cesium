  ...
  (f = {
    ...
    (z = {
      ...
      readDataOneSweep: function (e, t, a) {
        ...
        if (f.length === s * n) t.pixels.resultPixels = f;
          ...
          if (1 < n)
            ...
            for (d = 0; d < s; d++) o[d] && (t.pixels.resultPixels[d] = f[c++]);
        }
      ...
      readHuffmanTree: function (e, t) {
        ...
        for (d = n; d < s; d++)
          0 < (u = c[(o = d - (d < r ? 0 : r))].first) &&
            ...
            u <= 32 - g
              ? 32 === (g += u) && ((g = 0), (w = m[++p]))
              : ((g += u - 32), (w = m[++p]), (c[o].second |= w >>> (32 - g))));
        var x = 0,
          k = 0,
          y = new V();
      ...
      readHuffman: function (e, t, a) {
        ...
        0 < I && (y++, (I = 0));
        for (
          var V = k[y], A = 1 === t.encodeMode, B = new a(p * h), D = B, S = 0;
          S < d.numDims;
          S++
        ) {
          if (
      ...
      readTiles: function (e, t, a) {
        ...
        for (
          ...
          for (c = V !== u - 1 ? s : C, A = 0; A < f; A++)
            for (
              B = V * r * s + A * s, p = r - (d = A !== f - 1 ? s : F), v = 0;
              v < L;
              v++
            ) {
              if (
                ...
                P++,
                (g =
                  ((m = (x = new DataView(e, t.ptr, Math.min(10, h))).getUint8(
                    0
                  )) >>
                    6) &
                  255),
              ...
              if (2 != I)
                if (0 == I) {
                  if (
                    ...
                    (t.ptr += P),
                    (D = (D = c * d * o) < (w = e.byteLength - t.ptr) ? D : w),
      ...
      constructConstantSurface: function (e) {
        ...
        if (o)
          ...
          else for (l = 0; l < r; l++) o[l] && (e.pixels.resultPixels[l] = a);
