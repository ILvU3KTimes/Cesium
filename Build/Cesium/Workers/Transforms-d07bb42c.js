define([
  ...
  function At() {
      ...
      return (
        0 < s &&
          (e =
            n || !a
              ? C(e, r, i, n)
              : e.slice(0, t.length) + C("", s, "0", !0) + e.slice(t.length)),
        e
      );
    }
    function v(e, t, n, r, a, i, s) {
      ...
      return (
        (e =
          ...
          C(o.toString(t), i || 0, "0", !1)),
        w(e, n, r, a, s)
      );
    }
    function g(e, t, n, r, a, i) {
      return null != r && (e = e.slice(0, r)), w(e, "", t, n, a, i);
    }
    var x = arguments,
      E = 0,
      e = x[E++];
    return e.replace(
      ...
      function (e, t, n, r, a, i, s) {
        ...
        if ("%%" == e) return "%";
        for (
          var c = !1, d = "", f = !1, h = !1, p = " ", m = n.length, y = 0;
          n && y < m;
          y++
        )
          switch (n.charAt(y)) {
        ...
        switch (
          ((i = i
            ...
            ? 0
            : void 0),
          (l = t ? x[t.slice(0, -1)] : x[E++]),
          s)
        ) {
          case "s":
            return g(String(l), c, r, i, f, p);
          case "c":
            return g(String.fromCharCode(+l), c, r, i, f);
          case "b":
            return v(l, 2, h, c, r, i, f);
          case "o":
            return v(l, 8, h, c, r, i, f);
          case "x":
            return v(l, 16, h, c, r, i, f);
          case "X":
            return v(l, 16, h, c, r, i, f).toUpperCase();
          case "u":
            return v(l, 10, h, c, r, i, f);
          case "i":
          case "d":
            return (
              (o = +l || 0),
              (l =
                (u = (o = Math.round(o - (o % 1))) < 0 ? "-" : d) +
                C(String(Math.abs(o)), i, "0", !1)),
              w(l, u, c, r, f)
            );
          case "e":
          case "E":
          ...
          case "G":
            return (
              (u = (o = +l) < 0 ? "-" : d),
              (t = ["toExponential", "toFixed", "toPrecision"][
                "efg".indexOf(s.toLowerCase())
              ]),
              (s = ["toString", "toUpperCase"]["eEfFgG".indexOf(s) % 2]),
              (l = u + Math.abs(o)[t](i)),
              w(l, u, c, r, f)[s]()
            );
          default:
  ...
  (Qt.fromGregorianDate = function (e, t) {
    ...
    (Qt.fromIso8601 = function (e, t) {
      ...
      if (
          ...
          : (null !== (i = f.match(Yt))
              ...
              : null !== (i = f.match(Zt)) &&
                ...
                (h =
                  ...
                  3)),
            (r = new Date(Date.UTC(n, 0, 1))).setUTCDate(h),
            (s = r.getUTCMonth() + 1),
            (o = r.getUTCDate())),
        (a = qt(n)),
        R.defined(e))
        ...
        null !== (i = e.match(Gt))
          ? ((u = +i[1]),
            ...
            (p = 5))
          : null !== (i = e.match(Jt))
          ? ((u = +i[1]), (l = +i[2]), (c = 60 * +(i[3] || 0)), (p = 4))
          : null !== (i = e.match(Ht)) &&
            ((u = +i[1]), (l = 60 * +(i[2] || 0)), (p = 3));
        var h = i[p],
          e = +i[p + 1],
          p = +(i[p + 2] || 0);
        switch (h) {
          ...
          case "Z":
            break;
          default:
            l += new Date(Date.UTC(n, s - 1, o, u, l)).getTimezoneOffset();
        }
      }
      p = 60 === c;
      for (p && c--; 60 <= l; ) (l -= 60), u++;
      for (; 24 <= u; ) (u -= 24), o++;
      for (r = a && 2 === s ? 29 : Nt[s - 1]; r < o; )
        (o -= r),
          12 < ++s && ((s -= 12), n++),
          (r = a && 2 === s ? 29 : Nt[s - 1]);
      for (; l < 0; ) (l += 60), u--;
      for (; u < 0; ) (u += 24), o--;
      for (; o < 1; )
        --s < 1 && ((s += 12), n--), (o += r = a && 2 === s ? 29 : Nt[s - 1]);
      d = Wt(n, s, o, u, l, c, d);
      return (
        R.defined(t)
          ? (Bt(d[0], d[1], t), Vt(t))
          : (t = new Qt(d[0], d[1], Pt.UTC)),
        p && Qt.addSeconds(t, 1, t),
        t
      );
    }),
    (Qt.now = function (e) {
    ...
    s.resolve(
      (function (e, t) {
        ...
        switch (t) {
          ...
          case "document":
            return new DOMParser().parseFromString(Hn(r, e), n);
          case "json":
            return JSON.parse(Hn(r, e));
        }
      })(o, a)
    );
  }),
